...
static void InitDefaultsscc_info_GetFriendsListRequest_friend_2eproto() {
  ...
  {
    void* ptr = &::myRPC::_GetFriendsListRequest_default_instance_;
    new (ptr) ::myRPC::GetFriendsListRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::myRPC::GetFriendsListRequest::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_GetFriendsListResponse_friend_2eproto() {
  ...
  {
    void* ptr = &::myRPC::_GetFriendsListResponse_default_instance_;
    new (ptr) ::myRPC::GetFriendsListResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::myRPC::GetFriendsListResponse::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::myRPC::GetFriendsListRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::myRPC::GetFriendsListRequest, id_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::myRPC::GetFriendsListResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::myRPC::GetFriendsListResponse, result_),
  PROTOBUF_FIELD_OFFSET(::myRPC::GetFriendsListResponse, friends_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::myRPC::ResultCode)},
  { 7, -1, sizeof(::myRPC::GetFriendsListRequest)},
  { 13, -1, sizeof(::myRPC::GetFriendsListResponse)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::myRPC::_ResultCode_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::myRPC::_GetFriendsListRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::myRPC::_GetFriendsListResponse_default_instance_),
};

const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014friend.proto\022\005myRPC\"-\n\nResultCode\022\017\n\007e"
  "rrcode\030\001 \001(\005\022\016\n\006errmsg\030\002 \001(\014\"#\n\025GetFrien"
  "dsListRequest\022\n\n\002id\030\001 \001(\r\"L\n\026GetFriendsL"
  "istResponse\022!\n\006result\030\001 \001(\0132\021.myRPC.Resu"
  "ltCode\022\017\n\007friends\030\002 \003(\0142a\n\020FriendService"
  "Rpc\022M\n\016GetFriendsList\022\034.myRPC.GetFriends"
  "ListRequest\032\035.myRPC.GetFriendsListRespon"
...
GetFriendsListRequest::GetFriendsListRequest()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:myRPC.GetFriendsListRequest)
}
GetFriendsListRequest::GetFriendsListRequest(const GetFriendsListRequest& from)
  ...
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  id_ = from.id_;
  // @@protoc_insertion_point(copy_constructor:myRPC.GetFriendsListRequest)
}
...
GetFriendsListRequest::~GetFriendsListRequest() {
  // @@protoc_insertion_point(destructor:myRPC.GetFriendsListRequest)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:myRPC.GetFriendsListRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendsListRequest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:myRPC.GetFriendsListRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:myRPC.GetFriendsListRequest)
  return target;
}

size_t GetFriendsListRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:myRPC.GetFriendsListRequest)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:myRPC.GetFriendsListRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendsListRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendsListRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:myRPC.GetFriendsListRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:myRPC.GetFriendsListRequest)
    MergeFrom(*source);
  }
}

void GetFriendsListRequest::MergeFrom(const GetFriendsListRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:myRPC.GetFriendsListRequest)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:myRPC.GetFriendsListRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:myRPC.GetFriendsListRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void GetFriendsListResponse::InitAsDefaultInstance() {
  ::myRPC::_GetFriendsListResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::myRPC::ResultCode*>(
      ::myRPC::ResultCode::internal_default_instance());
}
class GetFriendsListResponse::_Internal {
 public:
  static const ::myRPC::ResultCode& result(const GetFriendsListResponse* msg);
};
...
GetFriendsListResponse::GetFriendsListResponse()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:myRPC.GetFriendsListResponse)
}
GetFriendsListResponse::GetFriendsListResponse(const GetFriendsListResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:myRPC.GetFriendsListResponse)
}
...
GetFriendsListResponse::~GetFriendsListResponse() {
  // @@protoc_insertion_point(destructor:myRPC.GetFriendsListResponse)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:myRPC.GetFriendsListResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendsListResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:myRPC.GetFriendsListResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:myRPC.GetFriendsListResponse)
  return target;
}

size_t GetFriendsListResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:myRPC.GetFriendsListResponse)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:myRPC.GetFriendsListResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendsListResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendsListResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:myRPC.GetFriendsListResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:myRPC.GetFriendsListResponse)
    MergeFrom(*source);
  }
}

void GetFriendsListResponse::MergeFrom(const GetFriendsListResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:myRPC.GetFriendsListResponse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:myRPC.GetFriendsListResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:myRPC.GetFriendsListResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void FriendServiceRpc::GetFriendsList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::myRPC::GetFriendsListRequest*,
                         ::myRPC::GetFriendsListResponse*,
  ...
  switch(method->index()) {
    case 0:
      GetFriendsList(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::myRPC::GetFriendsListRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::myRPC::GetFriendsListResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::myRPC::GetFriendsListRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::myRPC::GetFriendsListResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::myRPC::GetFriendsListRequest* Arena::CreateMaybeMessage< ::myRPC::GetFriendsListRequest >(Arena* arena) {
  return Arena::CreateInternal< ::myRPC::GetFriendsListRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::myRPC::GetFriendsListResponse* Arena::CreateMaybeMessage< ::myRPC::GetFriendsListResponse >(Arena* arena) {
  return Arena::CreateInternal< ::myRPC::GetFriendsListResponse >(arena);
}
